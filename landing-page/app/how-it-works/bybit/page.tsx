  ...
  return (
    <Card className="p-6 md:p-8">
      <div className="flex items-start gap-4 mb-6">
        <div className="h-12 w-12 rounded-2xl bg-cyan-400/15 border border-cyan-400/20 flex items-center justify-center text-cyan-300 shrink-0">
          {icon}
        </div>
...
export default function BybitUTAHowItWorksPage() {
  return (
    <main className="min-h-screen bg-[#020813] text-white font-hoves lg:mt-24 mt-10">
      {/* Background */}
      <div className="fixed inset-0 -z-10 bg-[radial-gradient(circle_at_top_right,rgba(34,211,238,0.12),transparent_20%),radial-gradient(circle_at_20%_20%,rgba(59,130,246,0.10),transparent_20%),linear-gradient(180deg,#020813_0%,#06111f_55%,#01050b_100%)]" />
      ...
      <section className="max-w-6xl mx-auto px-6 pt-20 pb-12 text-center">
        ...
        <p className="text-slate-400 text-lg leading-8 mt-5 max-w-3xl mx-auto">
          Securely connect your Bybit Unified Trading Account to the platform in
          a few guided steps.
        </p>
      ...
      <section className="max-w-6xl mx-auto px-6 py-6 space-y-6">
        ...
        >
          <p>
            If you already have an API key for trading on Bybit UTA, you can use
            this key and proceed to Step 2.
          </p>

          <p>
            In order to create an API key for the exchange, you need to have an
            account at{" "}
            <a
          ...
          <p>
            To create an account, click the Sign Up or Create Account button.
          </p>

          <p>
            After you are successfully logged in, find the button of your
            account and tap the API line.
          </p>

          <p>
            In the API management tab click the Create New Key button.
          </p>
          ...
          <p>
            Then your API key will be successfully added. After copying the keys
            please press the Understood button.
          </p>
        ...
        >
          ...
          <p>
            Next, enter the following items in the appropriate fields:
          </p>

          <div className="rounded-2xl border border-white/10 bg-white/5 p-5 space-y-3">
            {["API key", "Secret key", "Description for the key"].map((item) => (
              <div key={item} className="flex gap-3 items-start">
                <CheckCircle2
                  size={18}
                  className="text-cyan-300 mt-1 shrink-0"
          ...
          <p>
            After integrating the API key from Bybit UTA exchange, you will see
            two added accounts in the Exchange Accounts section: Bybit Spot
            (spot) and Bybit (futures).
          </p>
          ...
          <div className="rounded-2xl border border-cyan-400/20 bg-cyan-400/10 p-4 text-cyan-200 flex gap-3">
            <ShieldCheck size={18} className="mt-1 shrink-0" />
            <span>
              Important! Please note that in order to trade on the platform, you
              need to have available balance on the Bybit exchange.
            </span>
          </div>
        </Step>
      </section>
      ...
      <section className="max-w-6xl mx-auto px-6 pt-6 pb-24">
        <Card className="p-8 md:p-12 text-center border-cyan-400/20 shadow-[0_0_60px_rgba(34,211,238,0.08)]">
          <div className="h-16 w-16 rounded-3xl bg-cyan-400/10 border border-cyan-400/20 flex items-center justify-center mx-auto mb-6 text-cyan-300">
            <Rocket size={28} />
          </div>
