...
export default function CategoryCard({ title, description, tags }: CategoryCardProps) {
  return (
    <div className="group rounded-[10px] p-5 w-full h-full min-h-[150px] border border-white/10 bg-gradient-to-br from-[#0b173699] to-[#0a112499] backdrop-blur-md hover:border-white/20 transition-colors duration-300">
