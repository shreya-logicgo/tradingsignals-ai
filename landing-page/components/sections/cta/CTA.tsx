            ...
            <div className="max-w-7xl mx-auto px-6 md:px-12 lg:px-24">
                <div className="flex flex-col gap-6 lg:gap-10">
                    ...
                    <div className="flex flex-col items-center text-center gap-2 max-w-[500px] mx-auto">
                        ...
                        <p className="font-hoves font-light text-sm md:text-base text-[#c7ccd2] leading-relaxed" style={{ fontFamily: "var(--font-hoves)" }}>
                    ...
                    <div className="flex flex-col gap-12">
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 md:gap-10 lg:gap-12">
                            {posts.map((post, i) => (
                                <div
                                    key={i}
                                    className="group h-[500px] flex flex-col cursor-pointer transition-transform duration-300 hover:-translate-y-2"
                                >
                                    {/* Image - Fixed Ratio */}
                                    ...
                                    {/* Content Container - Uses flex-1 to fill the remaining 500px height */}
                                    <div className="flex flex-col flex-1 pt-6 overflow-hidden">
                                        ...
                                        {/* Description - Fixed height/Clamping to prevent pushing the card down */}
                                        <div className="flex-1">
                                            <p
                                                className="text-sm md:text-base text-[#c7ccd2] leading-relaxed line-clamp-3 md:line-clamp-4"
                                                style={{ fontFamily: "var(--font-hoves)" }}
                                            >
                                                {post.description}
                                            </p>
                                        ...
                                        {/* View More - Anchored to bottom because of flex-1 above */}
                                        <div className="mt-auto pt-4 flex-shrink-0">
                                            <span className="text-sm text-white underline underline-offset-4 decoration-white/30 group-hover:decoration-white transition-all" style={{ fontFamily: "var(--font-hoves)" }}>
                                                View more
                                            </span>
                                        </div>
                                    </div>
                        ...
                        <div className="flex justify-center mt-4">
                            <button className="px-8 py-3 rounded-full font-mono border border-white text-white text-sm font-medium font-hoves transition-all duration-300 hover:bg-white hover:text-black">
                                Learn More
                            </button>
                        </div>
                    </div>
